...
// in login/test/helpers/test_helpers.dart.
...
import 'package:login/services/api_service.dart' as _i10;
import 'package:login/services/shared_preferences_service.dart' as _i9;
...
class MockSharedPreferencesService extends _i1.Mock
  ...
  @override
  dynamic saveProfile({required int? userProfile}) => super.noSuchMethod(
        Invocation.method(
          #saveProfile,
          [],
...
class MockApiService extends _i1.Mock implements _i10.ApiService {
  @override
  _i3.Dio get api => (super.noSuchMethod(
  ...
  @override
  set api(_i3.Dio? _api) => super.noSuchMethod(
        Invocation.setter(
          #api,
          _api,
        ),
